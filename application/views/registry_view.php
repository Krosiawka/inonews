...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        -->
        <input type="text" class="input-block-level" required="required" placeholder="Логин" name="login">
        ...
        <input type="email" class="input-block-level" required="required" placeholder="Email" name="email">
        <?php  echo form_error('email'); ?>
        <?php if (isset($error_email)) echo $error_email;?>
        <button class="btn btn-large btn-primary btn-block" type="submit">Зарегестрироваться</button>
      </form>
