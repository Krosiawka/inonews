...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <?php echo form_open('restore', $attributes); ?>
        <h3 class="form-signin-heading">Востановление пароля</h3>
        <p>На введенный вами адрес электронной почты будет отправленно письмо с сылкой на восстановление пароля</p>
        <input type="text" class="input-block-level" required="required" placeholder="Введите email" name="email">
        <?php echo form_error('email');?>
        <?php if (isset($error)) echo $error;?>
        <button class="btn btn-large btn-primary btn-block" type="submit">Отправить</button>
      </form>
